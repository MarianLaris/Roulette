...
//		public static float Mod_easeInBack(float start, float end, float val)
//		{
//			end -= start;
//			val /= 1;
//			float s= 0.70158f;
...
//		}
//		
//		public static float Mod_easeOutBack(float start, float end, float val)
//		{
//			float s= 0.70158f;
//			end -= start;
//			val = (val / 1) - 1;
...
//		}
//		
//		public static float Mod_easeInOutBack(float start, float end, float val)
//		{
//			float s= 1.40158f;
//			end -= start;
//			//Debug.Log("Before "+val);
//			val /= .5f;
//			//Debug.Log("After   "+val);
//			if ((val) < 1){
//				s *= (1.025f);
...
//		}
//		
//		public static float Mod_easeOutInBack(float start, float end, float val)
//		{
//			float s= 1.70158f;
//			end -= start;
//			//val /= .5f;
